...
def validate_car_model():
    # Checks if the car model is the right length.
...
def validate_car_brand():
    # Checks if the car brand is the right length.
...
def validate_car_year():
    # Checks if the car year is a valid year.
    try:
...
def validate_car_color():
    # Checks if the car color only contains allowed characters.
...
def validate_search_query():
    # Checks if the search text is valid.
